                    ...
                    <ProductDetails item={item} />{
                        qty < 1
                            ? <Button onClick={(e) => { handleAddToCart(e, item) }}
                                className={`bg-blue-700 py-2 w-[100%] disabled:opacity-50 hover:opacity-[50%] rounded-md text-white mt-2`}><div className={`flex flex-row justify-center items-center gap-2 text-sm`}>Add to Cart</div></Button>
                            : <Button onClick={(e) => { handleRemoveFromCart(e, item) }}
                                className={`bg-red-500 py-2 w-[100%] disabled:opacity-50 hover:opacity-[50%] rounded-md text-white mt-2`}><div className={`flex flex- row justify-center items-center gap-2 text-sm`}>{<img className="h-4 w-4" src="/icons/cart.png" />}Remove from Cart</div></Button>
